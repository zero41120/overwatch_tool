 ...
 */var ib;function mh(){if(ib)return Qa;ib=1;var i=Symbol.for("react.transitional.element"),c=Symbol.for("react.fragment");function f(s,d,p){var y=null;if(p!==void 0&&(y=""+p),d.key!==void 0&&(y=""+d.key),"key"in d){p={};for(var O in d)O!=="key"&&(p[O]=d[O])}else p=d;return d=p.ref,{$$typeof:i,type:s,key:y,ref:d!==void 0?d:null,props:p}}return Qa.Fragment=c,Qa.jsx=f,Qa.jsxs=f,Qa}var ub;function vh(){return ub||(ub=1,jc.exports=mh()),jc.exports}var v=vh(),Gc={exports:{}},en={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ob;function Sh(){return ob||(ob=1,function(i){function c(x,z){var q=x.length;x.push(z);n:for(;0<q;){var an=q-1>>>1,h=x[an];if(0<d(h,z))x[an]=z,x[q]=h,q=an;else break n}}function f(x){return x.length===0?null:x[0]}function s(x){if(x.length===0)return null;var z=x[0],q=x.pop();if(q!==z){x[0]=q;n:for(var an=0,h=x.length,M=h>>>1;an<M;){var B=2*(an+1)-1,w=x[B],Y=B+1,nn=x[Y];if(0>d(w,q))Y<h&&0>d(nn,w)?(x[an]=nn,x[Y]=q,an=Y):(x[an]=w,x[B]=q,an=B);else if(Y<h&&0>d(nn,q))x[an]=nn,x[Y]=q,an=Y;else break n}}return z}function d(x,z){var q=x.sortIndex-z.sortIndex;return q!==0?q:x.id-z.id}if(i.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var p=performance;i.unstable_now=function(){return p.now()}}else{var y=Date,O=y.now();i.unstable_now=function(){return y.now()-O}}var S=[],g=[],N=1,L=null,j=3,W=!1,P=!1,K=!1,Z=!1,bn=typeof setTimeout=="function"?setTimeout:null,sn=typeof clearTimeout=="function"?clearTimeout:null,on=typeof setImmediate<"u"?setImmediate:null;function I(x){for(var z=f(g);z!==null;){if(z.callback===null)s(g);else if(z.startTime<=x)s(g),z.sortIndex=z.expirationTime,c(S,z);else break;z=f(g)}}function U(x){if(K=!1,I(x),!P)if(f(S)!==null)P=!0,F||(F=!0,wn());else{var z=f(g);z!==null&&Nn(U,z.startTime-x)}}var F=!1,hn=-1,mn=5,vn=-1;function Ce(){return Z?!0:!(i.unstable_now()-vn<mn)}function ee(){if(Z=!1,F){var x=i.unstable_now();vn=x;var z=!0;try{n:{P=!1,K&&(K=!1,sn(hn),hn=-1),W=!0;var q=j;try{e:{for(I(x),L=f(S);L!==null&&!(L.expirationTime>x&&Ce());){var an=L.callback;if(typeof an=="function"){L.callback=null,j=L.priorityLevel;var h=an(L.expirationTime<=x);if(x=i.unstable_now(),typeof h=="function"){L.callback=h,I(x),z=!0;break e}L===f(S)&&s(S),I(x)}else s(S);L=f(S)}if(L!==null)z=!0;else{var M=f(g);M!==null&&Nn(U,M.startTime-x),z=!1}}break n}finally{L=null,j=q,W=!1}z=void 0}}finally{z?wn():F=!1}}}var wn;if(typeof on=="function")wn=function(){on(ee)};else if(typeof MessageChannel<"u"){var fn=new MessageChannel,xn=fn.port2;fn.port1.onmessage=ee,wn=function(){xn.postMessage(null)}}else wn=function(){bn(ee,0)};function Nn(x,z){hn=bn(function(){x(i.unstable_now())},z)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(x){x.callback=null},i.unstable_forceFrameRate=function(x){0>x||125<x?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):mn=0<x?Math.floor(1e3/x):5},i.unstable_getCurrentPriorityLevel=function(){return j},i.unstable_next=function(x){switch(j){case 1:case 2:case 3:var z=3;break;default:z=j}var q=j;j=z;try{return x()}finally{j=q}},i.unstable_requestPaint=function(){Z=!0},i.unstable_runWithPriority=function(x,z){switch(x){case 1:case 2:case 3:case 4:case 5:break;default:x=3}var q=j;j=x;try{return z()}finally{j=q}},i.unstable_scheduleCallback=function(x,z,q){var an=i.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?an+q:an):q=an,x){case 1:var h=-1;break;case 2:h=250;break;case 5:h=1073741823;break;case 4:h=1e4;break;default:h=5e3}return h=q+h,x={id:N++,callback:z,priorityLevel:x,startTime:q,expirationTime:h,sortIndex:-1},q>an?(x.sortIndex=q,c(g,x),f(S)===null&&x===f(g)&&(K?(sn(hn),hn=-1):K=!0,Nn(U,q-an))):(x.sortIndex=h,c(S,x),P||W||(P=!0,F||(F=!0,wn()))),x},i.unstable_shouldYield=Ce,i.unstable_wrapCallback=function(x){var z=j;return function(){var q=j;j=z;try{return x.apply(this,arguments)}finally{j=q}}}}(Vc)),Vc}var fb;function Eh(){return fb||(fb=1,qc.exports=Sh()),qc.exports}var Kc={exports:{}},Fn={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var db;function Ah(){if(db)return Fn;db=1;var i=Si();function c(S){var g="https://react.dev/errors/"+S;if(1<arguments.length){g+="?args[]="+encodeURIComponent(arguments[1]);for(var N=2;N<arguments.length;N++)g+="&args[]="+encodeURIComponent(arguments[N])}return"Minified React error #"+S+"; visit "+g+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function f(){}var s={d:{f,r:function(){throw Error(c(522))},D:f,C:f,L:f,m:f,X:f,S:f,M:f},p:0,findDOMNode:null},d=Symbol.for("react.portal");function p(S,g,N){var L=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:d,key:L==null?null:""+L,children:S,containerInfo:g,implementation:N}}var y=i.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function O(S,g){if(S==="font")return"";if(typeof g=="string")return g==="use-credentials"?g:""}return Fn.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,Fn.createPortal=function(S,g){var N=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!g||g.nodeType!==1&&g.nodeType!==9&&g.nodeType!==11)throw Error(c(299));return p(S,g,null,N)},Fn.flushSync=function(S){var g=y.T,N=s.p;try{if(y.T=null,s.p=2,S)return S()}finally{y.T=g,s.p=N,s.d.f()}},Fn.preconnect=function(S,g){typeof S=="string"&&(g?(g=g.crossOrigin,g=typeof g=="string"?g==="use-credentials"?g:"":void 0):g=null,s.d.C(S,g))},Fn.prefetchDNS=function(S){typeof S=="string"&&s.d.D(S)},Fn.preinit=function(S,g){if(typeof S=="string"&&g&&typeof g.as=="string"){var N=g.as,L=O(N,g.crossOrigin),j=typeof g.integrity=="string"?g.integrity:void 0,W=typeof g.fetchPriority=="string"?g.fetchPriority:void 0;N==="style"?s.d.S(S,typeof g.precedence=="string"?g.precedence:void 0,{crossOrigin:L,integrity:j,fetchPriority:W}):N==="script"&&s.d.X(S,{crossOrigin:L,integrity:j,fetchPriority:W,nonce:typeof g.nonce=="string"?g.nonce:void 0})}},Fn.preinitModule=function(S,g){if(typeof S=="string")if(typeof g=="object"&&g!==null){if(g.as==null||g.as==="script"){var N=O(g.as,g.crossOrigin);s.d.M(S,{crossOrigin:N,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0})}}else g==null&&s.d.M(S)},Fn.preload=function(S,g){if(typeof S=="string"&&typeof g=="object"&&g!==null&&typeof g.as=="string"){var N=g.as,L=O(N,g.crossOrigin);s.d.L(S,N,{crossOrigin:L,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0,type:typeof g.type=="string"?g.type:void 0,fetchPriority:typeof g.fetchPriority=="string"?g.fetchPriority:void 0,referrerPolicy:typeof g.referrerPolicy=="string"?g.referrerPolicy:void 0,imageSrcSet:typeof g.imageSrcSet=="string"?g.imageSrcSet:void 0,imageSizes:typeof g.imageSizes=="string"?g.imageSizes:void 0,media:typeof g.media=="string"?g.media:void 0})}},Fn.preloadModule=function(S,g){if(typeof S=="string")if(g){var N=O(g.as,g.crossOrigin);s.d.m(S,{as:typeof g.as=="string"&&g.as!=="script"?g.as:void 0,crossOrigin:N,integrity:typeof g.integrity=="string"?g.integrity:void 0})}else s.d.m(S)},Fn.requestFormReset=function(S){s.d.r(S)},Fn.unstable_batchedUpdates=function(S,g){return S(g)},Fn.useFormState=function(S,g,N){return y.H.useFormState(S,g,N)},Fn.useFormStatus=function(){return y.H.useHostTransitionStatus()},Fn.version="19.1.0",Fn}var bb;function Rh(){if(bb)return Kc.exports;bb=1;function i(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(i)}catch(c){console.error(c)}}return i(),Kc.exports=Ah(),Kc.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var yb;function Nh(){if(yb)return Xc;yb=1;var i=Si();function c(S,g){return S===g&&(S!==0||1/S===1/g)||S!==S&&g!==g}var f=typeof Object.is=="function"?Object.is:c,s=i.useSyncExternalStore,d=i.useRef,p=i.useEffect,y=i.useMemo,O=i.useDebugValue;return Xc.useSyncExternalStoreWithSelector=function(S,g,N,L,j){var W=d(null);if(W.current===null){var P={hasValue:!1,value:null};W.current=P}else P=W.current;W=y(function(){function Z(U){if(!bn){if(bn=!0,sn=U,U=L(U),j!==void 0&&P.hasValue){var F=P.value;if(j(F,U))return on=F}return on=U}if(F=on,f(sn,U))return F;var hn=L(U);return j!==void 0&&j(F,hn)?(sn=U,F):(sn=U,on=hn)}var bn=!1,sn,on,I=N===void 0?null:N;return[function(){return Z(g())},I===null?void 0:function(){return Z(I())}]},[g,N,L,j]);var K=s(S,W[0],W[1]);return p(function(){P.hasValue=!0,P.value=K},[K]),O(K),K},Xc}var mb;function xh(){return mb||(mb=1,Qc.exports=Nh()),Qc.exports}var Dh=xh();function Mh(i){i()}function Ch(){let i=null,c=null;return{clear(){i=null,c=null},notify(){Mh(()=>{let f=i;for(;f;)f.callback(),f=f.next})},get(){const f=[];let s=i;for(;s;)f.push(s),s=s.next;return f},subscribe(f){let s=!0;const d=c={callback:f,next:null,prev:c};return d.prev?d.prev.next=d:i=d,function(){!s||i===null||(s=!1,d.next?d.next.prev=d.prev:c=d.prev,d.prev?d.prev.next=d.next:i=d.next)}}}}var vb={notify(){},get:()=>[]};function Hh(i,c){let f,s=vb,d=0,p=!1;function y(K){N();const Z=s.subscribe(K);let bn=!1;return()=>{bn||(bn=!0,Z(),L())}}function O(){s.notify()}function S(){P.onStateChange&&P.onStateChange()}function g(){return p}function N(){d++,f||(f=i.subscribe(S),s=Ch())}function L(){d--,f&&d===0&&(f(),f=void 0,s.clear(),s=vb)}function j(){p||(p=!0,N())}function W(){p&&(p=!1,L())}const P={addNestedSub:y,notifyNestedSubs:O,handleChangeWrapper:S,isSubscribed:g,trySubscribe:j,tryUnsubscribe:W,getListeners:()=>s};return P}var Uh=()=>typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Lh=Uh(),Bh=()=>typeof navigator<"u"&&navigator.product==="ReactNative",wh=Bh(),zh=()=>Lh||wh?$.useLayoutEffect:$.useEffect,jh=zh(),kc=Symbol.for("react-redux-context"),Wc=typeof globalThis<"u"?globalThis:{};function Gh(){if(!$.createContext)return{};const i=Wc[kc]??(Wc[kc]=new Map);let c=i.get($.createContext);return c||(c=$.createContext(null),i.set($.createContext,c)),c}var Ut=Gh();function Yh(i){const{children:c,context:f,serverState:s,store:d}=i,p=$.useMemo(()=>{const S=Hh(d);return{store:d,subscription:S,getServerState:s?()=>s:void 0}},[d,s]),y=$.useMemo(()=>d.getState(),[d]);jh(()=>{const{subscription:S}=p;return S.onStateChange=S.notifyNestedSubs,S.trySubscribe(),y!==d.getState()&&S.notifyNestedSubs(),()=>{S.tryUnsubscribe(),S.onStateChange=void 0}},[p,y]);const O=f||Ut;return $.createElement(O.Provider,{value:p},c)}var qh=Yh;function cs(i=Ut){return function(){return $.useContext(i)}}var Cb=cs();function Hb(i=Ut){const c=i===Ut?Cb:cs(i),f=()=>{const{store:s}=c();return s};return Object.assign(f,{withTypes:()=>f}),f}var Vh=Hb();function Kh(i=Ut){const c=i===Ut?Vh:Hb(i),f=()=>c().dispatch;return Object.assign(f,{withTypes:()=>f}),f}var Qh=Kh(),Xh=(i,c)=>i===c;function kh(i=Ut){const c=i===Ut?Cb:cs(i),f=(s,d={})=>{const{equalityFn:p=Xh}=typeof d=="function"?{equalityFn:d}:d,y=c(),{store:O,subscription:S,getServerState:g}=y;$.useRef(!0);const N=$.useCallback({[s.name](j){return s(j)}}[s.name],[s]),L=Dh.useSyncExternalStoreWithSelector(S.addNestedSub,O.getState,g||O.getState,N,p);return $.useDebugValue(L),L};return Object.assign(f,{withTypes:()=>f}),f}var Wh=kh();const ct=Qh,me=Wh;function In(i){return`Minified Redux error #${i}; visit https://redux.js.org/Errors?code=${i} for the full message or use the non-minified dev environment for full errors. `}var Zh=typeof Symbol=="function"&&Symbol.observable||"@@observable",gb=Zh,Zc=()=>Math.random().toString(36).substring(7).split("").join("."),Ih={INIT:`@@redux/INIT${Zc()}`,REPLACE:`@@redux/REPLACE${Zc()}`,PROBE_UNKNOWN_ACTION:()=>`@@redux/PROBE_UNKNOWN_ACTION${Zc()}`},pi=Ih;function ss(i){if(typeof i!="object"||i===null)return!1;let c=i;for(;Object.getPrototypeOf(c)!==null;)c=Object.getPrototypeOf(c);return Object.getPrototypeOf(i)===c||Object.getPrototypeOf(i)===null}function Ub(i,c,f){if(typeof i!="function")throw new Error(In(2));if(typeof c=="function"&&typeof f=="function"||typeof f=="function"&&typeof arguments[3]=="function")throw new Error(In(0));if(typeof c=="function"&&typeof f>"u"&&(f=c,c=void 0),typeof f<"u"){if(typeof f!="function")throw new Error(In(1));return f(Ub)(i,c)}let s=i,d=c,p=new Map,y=p,O=0,S=!1;function g(){y===p&&(y=new Map,p.forEach((Z,bn)=>{y.set(bn,Z)}))}function N(){if(S)throw new Error(In(3));return d}function L(Z){if(typeof Z!="function")throw new Error(In(4));if(S)throw new Error(In(5));let bn=!0;g();const sn=O++;return y.set(sn,Z),function(){if(bn){if(S)throw new Error(In(6));bn=!1,g(),y.delete(sn),p=null}}}function j(Z){if(!ss(Z))throw new Error(In(7));if(typeof Z.type>"u")throw new Error(In(8));if(typeof Z.type!="string")throw new Error(In(17));if(S)throw new Error(In(9));try{S=!0,d=s(d,Z)}finally{S=!1}return(p=y).forEach(sn=>{sn()}),Z}function W(Z){if(typeof Z!="function")throw new Error(In(10));s=Z,j({type:pi.REPLACE})}function P(){const Z=L;return{subscribe(bn){if(typeof bn!="object"||bn===null)throw new Error(In(11));function sn(){const I=bn;I.next&&I.next(N())}return sn(),{unsubscribe:Z(sn)}},[gb](){return this}}}return j({type:pi.INIT}),{dispatch:j,subscribe:L,getState:N,replaceReducer:W,[gb]:P}}function Jh(i){Object.keys(i).forEach(c=>{const f=i[c];if(typeof f(void 0,{type:pi.INIT})>"u")throw new Error(In(12));if(typeof f(void 0,{type:pi.PROBE_UNKNOWN_ACTION()})>"u")throw new Error(In(13))})}function Ph(i){const c=Object.keys(i),f={};for(let p=0;p<c.length;p++){const y=c[p];typeof i[y]=="function"&&(f[y]=i[y])}const s=Object.keys(f);let d;try{Jh(f)}catch(p){d=p}return function(y={},O){if(d)throw d;let S=!1;const g={};for(let N=0;N<s.length;N++){const L=s[N],j=f[L],W=y[L],P=j(W,O);if(typeof P>"u")throw O&&O.type,new Error(In(14));g[L]=P,S=S||P!==W}return S=S||s.length!==Object.keys(y).length,S?g:y}}function hi(...i){return i.length===0?c=>c:i.length===1?i[0]:i.reduce((c,f)=>(...s)=>c(f(...s)))}function Fh(...i){return c=>(f,s)=>{const d=c(f,s);let p=()=>{throw new Error(In(15))};const y={getState:d.getState,dispatch:(S,...g)=>p(S,...g)},O=i.map(S=>S(y));return p=hi(...O)(d.dispatch),{...d,dispatch:p}}}function $h(i){return ss(i)&&"type"in i&&typeof i.type=="string"}var Lb=Symbol.for("immer-nothing"),Sb=Symbol.for("immer-draftable"),ve=Symbol.for("immer-state");function ze(i,...c){throw new Error(`[Immer] minified error nr: ${i}. Full error at: https://bit.ly/3cXEKWf`)}var kr=Object.getPrototypeOf;function er(i){return!!i&&!!i[ve]}function ut(i){var c;return i?Bb(i)||Array.isArray(i)||!!i[Sb]||!!((c=i.constructor)!=null&&c[Sb])||Ai(i)||Ri(i):!1}var ny=Object.prototype.constructor.toString();function Bb(i){if(!i||typeof i!="object")return!1;const c=kr(i);if(c===null)return!0;const f=Object.hasOwnProperty.call(c,"constructor")&&c.constructor;return f===Object?!0:typeof f=="function"&&Function.toString.call(f)===ny}function yi(i,c){Ei(i)===0?Reflect.ownKeys(i).forEach(f=>{c(f,i[f],i)}):i.forEach((f,s)=>c(s,f,i))}function Ei(i){const c=i[ve];return c?c.type_:Array.isArray(i)?1:Ai(i)?2:Ri(i)?3:0}function $c(i,c){return Ei(i)===2?i.has(c):Object.prototype.hasOwnProperty.call(i,c)}function wb(i,c,f){const s=Ei(i);s===2?i.set(c,f):s===3?i.add(f):i[c]=f}function ey(i,c){return i===c?i!==0||1/i===1/c:i!==i&&c!==c}function Ai(i){return i instanceof Map}function Ri(i){return i instanceof Set}function $t(i){return i.copy_||i.base_}function ns(i,c){if(Ai(i))return new Map(i);if(Ri(i))return new Set(i);if(Array.isArray(i))return Array.prototype.slice.call(i);const f=Bb(i);if(c===!0||c==="class_only"&&!f){const s=Object.getOwnPropertyDescriptors(i);delete s[ve];let d=Reflect.ownKeys(s);for(let p=0;p<d.length;p++){const y=d[p],O=s[y];O.writable===!1&&(O.writable=!0,O.configurable=!0),(O.get||O.set)&&(s[y]={configurable:!0,writable:!0,enumerable:O.enumerable,value:i[y]})}return Object.create(kr(i),s)}else{const s=kr(i);if(s!==null&&f)return{...i};const d=Object.create(s);return Object.assign(d,i)}}function os(i,c=!1){return Ti(i)||er(i)||!ut(i)||(Ei(i)>1&&(i.set=i.add=i.clear=i.delete=ty),Object.freeze(i),c&&Object.entries(i).forEach(([f,s])=>os(s,!0))),i}function ty(){ze(2)}function Ti(i){return Object.isFrozen(i)}var ry={};function tr(i){const c=ry[i];return c||ze(0,i),c}var Wa;function zb(){return Wa}function ay(i,c){return{drafts_:[],parent_:i,immer_:c,canAutoFreeze_:!0,unfinalizedDrafts_:0}}function Eb(i,c){c&&(tr("Patches"),i.patches_=[],i.inversePatches_=[],i.patchListener_=c)}function es(i){ts(i),i.drafts_.forEach(ly),i.drafts_=null}function ts(i){i===Wa&&(Wa=i.parent_)}function Ab(i){return Wa=ay(Wa,i)}function ly(i){const c=i[ve];c.type_===0||c.type_===1?c.revoke_():c.revoked_=!0}function Rb(i,c){c.unfinalizedDrafts_=c.drafts_.length;const f=c.drafts_[0];return i!==void 0&&i!==f?(f[ve].modified_&&(es(c),ze(4)),ut(i)&&(i=mi(c,i),c.parent_||vi(c,i)),c.patches_&&tr("Patches").generateReplacementPatches_(f[ve].base_,i,c.patches_,c.inversePatches_)):i=mi(c,f,[]),es(c),c.patches_&&c.patchListener_(c.patches_,c.inversePatches_),i!==Lb?i:void 0}function mi(i,c,f){if(Ti(c))return c;const s=c[ve];if(!s)return yi(c,(d,p)=>Tb(i,s,c,d,p,f)),c;if(s.scope_!==i)return c;if(!s.modified_)return vi(i,s.base_,!0),s.base_;if(!s.finalized_){s.finalized_=!0,s.scope_.unfinalizedDrafts_--;const d=s.copy_;let p=d,y=!1;s.type_===3&&(p=new Set(d),d.clear(),y=!0),yi(p,(O,S)=>Tb(i,s,d,O,S,f,y)),vi(i,d,!1),f&&i.patches_&&tr("Patches").generatePatches_(s,f,i.patches_,i.inversePatches_)}return s.copy_}function Tb(i,c,f,s,d,p,y){if(er(d)){const O=p&&c&&c.type_!==3&&!$c(c.assigned_,s)?p.concat(s):void 0,S=mi(i,d,O);if(wb(f,s,S),er(S))i.canAutoFreeze_=!1;else return}else y&&f.add(d);if(ut(d)&&!Ti(d)){if(!i.immer_.autoFreeze_&&i.unfinalizedDrafts_<1)return;mi(i,d),(!c||!c.scope_.parent_)&&typeof s!="symbol"&&Object.prototype.propertyIsEnumerable.call(f,s)&&vi(i,d)}}function vi(i,c,f=!1){!i.parent_&&i.immer_.autoFreeze_&&i.canAutoFreeze_&&os(c,f)}function iy(i,c){const f=Array.isArray(i),s={type_:f?1:0,scope_:c?c.scope_:zb(),modified_:!1,finalized_:!1,assigned_:{},parent_:c,base_:i,draft_:null,copy_:null,revoke_:null,isManual_:!1};let d=s,p=fs;f&&(d=[s],p=Za);const{revoke:y,proxy:O}=Proxy.revocable(d,p);return s.draft_=O,s.revoke_=y,O}var fs={get(i,c){if(c===ve)return i;const f=$t(i);if(!$c(f,c))return uy(i,f,c);const s=f[c];return i.finalized_||!ut(s)?s:s===Ic(i.base_,c)?(Jc(i),i.copy_[c]=as(s,i)):s},has(i,c){return c in $t(i)},ownKeys(i){return Reflect.ownKeys($t(i))},set(i,c,f){const s=jb($t(i),c);if(s!=null&&s.set)return s.set.call(i.draft_,f),!0;if(!i.modified_){const d=Ic($t(i),c),p=d==null?void 0:d[ve];if(p&&p.base_===f)return i.copy_[c]=f,i.assigned_[c]=!1,!0;if(ey(f,d)&&(f!==void 0||$c(i.base_,c)))return!0;Jc(i),rs(i)}return i.copy_[c]===f&&(f!==void 0||c in i.copy_)||Number.isNaN(f)&&Number.isNaN(i.copy_[c])||(i.copy_[c]=f,i.assigned_[c]=!0),!0},deleteProperty(i,c){return Ic(i.base_,c)!==void 0||c in i.base_?(i.assigned_[c]=!1,Jc(i),rs(i)):delete i.assigned_[c],i.copy_&&delete i.copy_[c],!0},getOwnPropertyDescriptor(i,c){const f=$t(i),s=Reflect.getOwnPropertyDescriptor(f,c);return s&&{writable:!0,configurable:i.type_!==1||c!=="length",enumerable:s.enumerable,value:f[c]}},defineProperty(){ze(11)},getPrototypeOf(i){return kr(i.base_)},setPrototypeOf(){ze(12)}},Za={};yi(fs,(i,c)=>{Za[i]=function(){return arguments[0]=arguments[0][0],c.apply(this,arguments)}});Za.deleteProperty=function(i,c){return Za.set.call(this,i,c,void 0)};Za.set=function(i,c,f){return fs.set.call(this,i[0],c,f,i[0])};function Ic(i,c){const f=i[ve];return(f?$t(f):i)[c]}function uy(i,c,f){var d;const s=jb(c,f);return s?"value"in s?s.value:(d=s.get)==null?void 0:d.call(i.draft_):void 0}function jb(i,c){if(!(c in i))return;let f=kr(i);for(;f;){const s=Object.getOwnPropertyDescriptor(f,c);if(s)return s;f=kr(f)}}function rs(i){i.modified_||(i.modified_=!0,i.parent_&&rs(i.parent_))}function Jc(i){i.copy_||(i.copy_=ns(i.base_,i.scope_.immer_.useStrictShallowCopy_))}var cy=class{constructor(i){this.autoFreeze_=!0,this.useStrictShallowCopy_=!1,this.produce=(c,f,s)=>{if(typeof c=="function"&&typeof f!="function"){const p=f;f=c;const y=this;return function(S=p,...g){return y.produce(S,N=>f.call(this,N,...g))}}typeof f!="function"&&ze(6),s!==void 0&&typeof s!="function"&&ze(7);let d;if(ut(c)){const p=Ab(this),y=as(c,void 0);let O=!0;try{d=f(y),O=!1}finally{O?es(p):ts(p)}return Eb(p,s),Rb(d,p)}else if(!c||typeof c!="object"){if(d=f(c),d===void 0&&(d=c),d===Lb&&(d=void 0),this.autoFreeze_&&os(d,!0),s){const p=[],y=[];tr("Patches").generateReplacementPatches_(c,d,p,y),s(p,y)}return d}else ze(1,c)},this.produceWithPatches=(c,f)=>{if(typeof c=="function")return(y,...O)=>this.produceWithPatches(y,S=>c(S,...O));let s,d;return[this.produce(c,f,(y,O)=>{s=y,d=O}),s,d]},typeof(i==null?void 0:i.autoFreeze)=="boolean"&&this.setAutoFreeze(i.autoFreeze),typeof(i==null?void 0:i.useStrictShallowCopy)=="boolean"&&this.setUseStrictShallowCopy(i.useStrictShallowCopy)}createDraft(i){ut(i)||ze(8),er(i)&&(i=sy(i));const c=Ab(this),f=as(i,void 0);return f[ve].isManual_=!0,ts(c),f}finishDraft(i,c){const f=i&&i[ve];(!f||!f.isManual_)&&ze(9);const{scope_:s}=f;return Eb(s,c),Rb(void 0,s)}setAutoFreeze(i){this.autoFreeze_=i}setUseStrictShallowCopy(i){this.useStrictShallowCopy_=i}applyPatches(i,c){let f;for(f=c.length-1;f>=0;f--){const d=c[f];if(d.path.length===0&&d.op==="replace"){i=d.value;break}}f>-1&&(c=c.slice(f+1));const s=tr("Patches").applyPatches_;return er(i)?s(i,c):this.produce(i,d=>s(d,c))}};function as(i,c){const f=Ai(i)?tr("MapSet").proxyMap_(i,c):Ri(i)?tr("MapSet").proxySet_(i,c):iy(i,c);return(c?c.scope_:zb()).drafts_.push(f),f}function sy(i){return er(i)||ze(10,i),Gb(i)}function Gb(i){if(!ut(i)||Ti(i))return i;const c=i[ve];let f;if(c){if(!c.modified_)return c.base_;c.finalized_=!0,f=ns(i,c.scope_.immer_.useStrictShallowCopy_)}else f=ns(i,!0);return yi(f,(s,d)=>{wb(f,s,Gb(d))}),c&&(c.finalized_=!1),f}var ge=new cy,Yb=ge.produce;ge.produceWithPatches.bind(ge);ge.setAutoFreeze.bind(ge);ge.setUseStrictShallowCopy.bind(ge);ge.applyPatches.bind(ge);ge.createDraft.bind(ge);ge.finishDraft.bind(ge);function qb(i){return({dispatch:f,getState:s})=>d=>p=>typeof p=="function"?p(f,s,i):d(p)}var oy=qb(),fy=qb,dy=typeof window<"u"&&window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__?window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__:function(){if(arguments.length!==0)return typeof arguments[0]=="object"?hi:hi.apply(null,arguments)};function _b(i,c){function f(...s){if(c){let d=c(...s);if(!d)throw new Error(it(0));return{type:i,payload:d.payload,..."meta"in d&&{meta:d.meta},..."error"in d&&{error:d.error}}}return{type:i,payload:s[0]}}return f.toString=()=>`${i}`,f.type=i,f.match=s=>$h(s)&&s.type===i,f}var Vb=class ka extends Array{constructor(...c){super(...c),Object.setPrototypeOf(this,ka.prototype)}static get[Symbol.species](){return ka}concat(...c){return super.concat.apply(this,c)}prepend(...c){return c.length===1&&Array.isArray(c[0])?new ka(...c[0].concat(this)):new ka(...c.concat(this))}};function Ob(i){return ut(i)?Yb(i,()=>{}):i}function oi(i,c,f){return i.has(c)?i.get(c):i.set(c,f(c)).get(c)}function by(i){return typeof i=="boolean"}var py=()=>function(c){const{thunk:f=!0,immutableCheck:s=!0,serializableCheck:d=!0,actionCreatorCheck:p=!0}=c??{};let y=new Vb;return f&&(by(f)?y.push(oy):y.push(fy(f.extraArgument))),y},hy="RTK_autoBatch",Nb=i=>c=>{setTimeout(c,i)},yy=(i={type:"raf"})=>c=>(...f)=>{const s=c(...f);let d=!0,p=!1,y=!1;const O=new Set,S=i.type==="tick"?queueMicrotask:i.type==="raf"?typeof window<"u"&&window.requestAnimationFrame?window.requestAnimationFrame:Nb(10):i.type==="callback"?i.queueNotification:Nb(i.timeout),g=()=>{y=!1,p&&(p=!1,O.forEach(N=>N()))};return Object.assign({},s,{subscribe(N){const L=()=>d&&N(),j=s.subscribe(L);return O.add(N),()=>{j(),O.delete(N)}},dispatch(N){var L;try{return d=!((L=N==null?void 0:N.meta)!=null&&L[hy]),p=!d,p&&(y||(y=!0,S(g))),s.dispatch(N)}finally{d=!0}}})},my=i=>function(f){const{autoBatch:s=!0}=f??{};let d=new Vb(i);return s&&d.push(yy(typeof s=="object"?s:void 0)),d};function vy(i){const c=py(),{reducer:f=void 0,middleware:s,devTools:d=!0,preloadedState:p=void 0,enhancers:y=void 0}=i||{};let O;if(typeof f=="function")O=f;else if(ss(f))O=Ph(f);else throw new Error(it(1));let S;typeof s=="function"?S=s(c):S=c();let g=hi;d&&(g=dy({trace:!1,...typeof d=="object"&&d}));const N=Fh(...S),L=my(N);let j=typeof y=="function"?y(L):L();const W=g(...j);return Ub(O,p,W)}function Kb(i){const c={},f=[];let s;const d={addCase(p,y){const O=typeof p=="string"?p:p.type;if(!O)throw new Error(it(28));if(O in c)throw new Error(it(29));return c[O]=y,d},addMatcher(p,y){return f.push({matcher:p,reducer:y}),d},addDefaultCase(p){return s=p,d}};return i(d),[c,f,s]}function gy(i){return typeof i=="function"}function Sy(i,c){let[f,s,d]=Kb(c),p;if(gy(i))p=()=>Ob(i());else{const O=Ob(i);p=()=>O}function y(O=p(),S){let g=[f[S.type],...s.filter(({matcher:N})=>N(S)).map(({reducer:N})=>N)];return g.filter(N=>!!N).length===0&&(g=[d]),g.reduce((N,L)=>{if(L)if(er(N)){const W=L(N,S);return W===void 0?N:W}else{if(ut(N))return Yb(N,j=>L(j,S));{const j=L(N,S);if(j===void 0){if(N===null)return N;throw Error("A case reducer on a non-draftable value must not return undefined")}return j}}return N},O)}return y.getInitialState=p,y}var Ey=Symbol.for("rtk-slice-createasyncthunk");function Ay(i,c){return`${i}/${c}`}function Ry({creators:i}={}){var f;const c=(f=i==null?void 0:i.asyncThunk)==null?void 0:f[Ey];return function(d){const{name:p,reducerPath:y=p}=d;if(!p)throw new Error(it(11));const O=(typeof d.reducers=="function"?d.reducers(Oy()):d.reducers)||{},S=Object.keys(O),g={sliceCaseReducersByName:{},sliceCaseReducersByType:{},actionCreators:{},sliceMatchers:[]},N={addCase(I,U){const F=typeof I=="string"?I:I.type;if(!F)throw new Error(it(12));if(F in g.sliceCaseReducersByType)throw new Error(it(13));return g.sliceCaseReducersByType[F]=U,N},addMatcher(I,U){return g.sliceMatchers.push({matcher:I,reducer:U}),N},exposeAction(I,U){return g.actionCreators[I]=U,N},exposeCaseReducer(I,U){return g.sliceCaseReducersByName[I]=U,N}};S.forEach(I=>{const U=O[I],F={reducerName:I,type:Ay(p,I),createNotation:typeof d.reducers=="function"};xy(U)?My(F,U,N,c):Ny(F,U,N)});function L(){const[I={},U=[],F=void 0]=typeof d.extraReducers=="function"?Kb(d.extraReducers):[d.extraReducers],hn={...I,...g.sliceCaseReducersByType};return Sy(d.initialState,mn=>{for(let vn in hn)mn.addCase(vn,hn[vn]);for(let vn of g.sliceMatchers)mn.addMatcher(vn.matcher,vn.reducer);for(let vn of U)mn.addMatcher(vn.matcher,vn.reducer);F&&mn.addDefaultCase(F)})}const j=I=>I,W=new Map,P=new WeakMap;let K;function Z(I,U){return K||(K=L()),K(I,U)}function bn(){return K||(K=L()),K.getInitialState()}function sn(I,U=!1){function F(mn){let vn=mn[I];return typeof vn>"u"&&U&&(vn=oi(P,F,bn)),vn}function hn(mn=j){const vn=oi(W,U,()=>new WeakMap);return oi(vn,mn,()=>{const Ce={};for(const[ee,wn]of Object.entries(d.selectors??{}))Ce[ee]=Ty(wn,mn,()=>oi(P,mn,bn),U);return Ce})}return{reducerPath:I,getSelectors:hn,get selectors(){return hn(F)},selectSlice:F}}const on={name:p,reducer:Z,actions:g.actionCreators,caseReducers:g.sliceCaseReducersByName,getInitialState:bn,...sn(y),injectInto(I,{reducerPath:U,...F}={}){const hn=U??y;return I.inject({reducerPath:hn,reducer:Z},F),{...on,...sn(hn,!0)}}};return on}}function Ty(i,c,f,s){function d(p,...y){let O=c(p);return typeof O>"u"&&s&&(O=f()),i(O,...y)}return d.unwrapped=i,d}var _y=Ry();function Oy(){function i(c,f){return{_reducerDefinitionType:"asyncThunk",payloadCreator:c,...f}}return i.withTypes=()=>i,{reducer(c){return Object.assign({[c.name](...f){return c(...f)}}[c.name],{_reducerDefinitionType:"reducer"})},preparedReducer(c,f){return{_reducerDefinitionType:"reducerWithPrepare",prepare:c,reducer:f}},asyncThunk:i}}function Ny({type:i,reducerName:c,createNotation:f},s,d){let p,y;if("reducer"in s){if(f&&!Dy(s))throw new Error(it(17));p=s.reducer,y=s.prepare}else p=s;d.addCase(i,p).exposeCaseReducer(c,p).exposeAction(c,y?_b(i,y):_b(i))}function xy(i){return i._reducerDefinitionType==="asyncThunk"}function Dy(i){return i._reducerDefinitionType==="reducerWithPrepare"}function My({type:i,reducerName:c},f,s,d){if(!d)throw new Error(it(18));const{payloadCreator:p,fulfilled:y,pending:O,rejected:S,settled:g,options:N}=f,L=d(i,p,N);s.exposeAction(c,L),y&&s.addCase(L.fulfilled,y),O&&s.addCase(L.pending,O),S&&s.addCase(L.rejected,S),g&&s.addMatcher(L.settled,g),s.exposeCaseReducer(c,{fulfilled:y||fi,pending:O||fi,rejected:S||fi,settled:g||fi})}function fi(){}function it(i){return`Minified Redux Toolkit error #${i}; visit https://redux-toolkit.js.org/Errors?code=${i} for the full message or use the non-minified dev environment for full errors. `}const Cy={hero:"Ashe",cash:11e3,equipped:Array(2).fill(""),toBuy:6,avoid:[],avoidEnabled:!1,weights:[{type:"",weight:1}],error:"",minValueEnabled:!1,minAttrGroups:[]},Qb=_y({name:"input",initialState:Cy,reducers:{setHero(i,c){i.hero=c.payload},setCash(i,c){i.cash=c.payload},setEquipped(i,c){i.equipped[c.payload.index]=c.payload.id},addEquippedSlot(i){i.equipped.length<6&&i.equipped.push("")},removeEquippedSlot(i,c){i.equipped.length>2&&i.equipped.splice(c.payload,1)},setToBuy(i,c){i.toBuy=c.payload},addAvoid(i,c){i.avoid.includes(c.payload)||i.avoid.push(c.payload)},removeAvoid(i,c){i.avoid=i.avoid.filter(f=>f!==c.payload)},toggleAvoidEnabled(i){i.avoidEnabled=!i.avoidEnabled},setWeightType(i,c){i.weights[c.payload.index].type=c.payload.type},setWeightValue(i,c){i.weights[c.payload.index].weight=c.payload.value},addWeightRow(i,c){i.weights.push({type:c.payload,weight:1})},removeWeightRow(i,c){i.weights.splice(c.payload,1)},setError(i,c){i.error=c.payload},toggleMinValueEnabled(i){i.minValueEnabled=!i.minValueEnabled},addMinGroup(i){i.minAttrGroups.push({attrs:[],value:0})},removeMinGroup(i,c){i.minAttrGroups.splice(c.payload,1)},setMinGroupValue(i,c){i.minAttrGroups[c.payload.index].value=c.payload.value},addAttrToGroup(i,c){const f=i.minAttrGroups[c.payload.index];f.attrs.includes(c.payload.attr)||f.attrs.push(c.payload.attr)},removeAttrFromGroup(i,c){const f=i.minAttrGroups[c.payload.index];f.attrs=f.attrs.filter(s=>s!==c.payload.attr)}}}),{setHero:Hy,setCash:Uy,setEquipped:xb,setToBuy:Xb,addAvoid:Ly,removeAvoid:By,toggleAvoidEnabled:wy,setWeightType:kb,setWeightValue:zy,addWeightRow:jy,removeWeightRow:Gy,setError:di,toggleMinValueEnabled:Yy,addMinGroup:qy,removeMinGroup:Vy,setMinGroupValue:Ky,addAttrToGroup:Qy,removeAttrFromGroup:Xy,addEquippedSlot:ky,removeEquippedSlot:Wy}=Qb.actions,Zy=Qb.reducer;function Iy({heroes:i}){const c=me(s=>s.input.present.hero),f=ct();return v.jsxs("div",{children:[v.jsx("label",{htmlFor:"hero-select",className:"block text-sm font-medium text-gray-700 mb-1",children:"Hero"}),v.jsx(Ia,{label:"Hero",placeholder:"Select hero",options:[{value:"",label:"Select hero"},...i.map(s=>({value:s,label:s}))],value:c,onChange:s=>f(Hy(s))})]})}function ds({value:i,onChange:c,min:f,max:s,step:d,placeholder:p,className:y,label:O}){const[S,g]=$.useState(i.toString());$.useEffect(()=>{g(i.toString())},[i]);const N=L=>{const j=L.target.value;if(g(j),j===""||j==="-")return;const W=Number(j);isNaN(W)||c(W)};return v.jsx("div",{className:`relative inline-block ${y||""}`,children:v.jsx("input",{type:"number",className:`block w-full px-3 py-2 text-sm font-medium text-gray-700 rounded border border-gray-300 bg-white shadow-sm
                    transition-colors focus:border-indigo-500 focus:ring-indigo-500`,value:S,onChange:N,inputMode:"decimal",pattern:".*",min:f,max:s,step:d,placeholder:p,"aria-label":O||p||"Number input"})})}function Jy(){const i=me(f=>f.input.present.cash),c=ct();return v.jsxs("div",{children:[v.jsx("label",{htmlFor:"total-cash",className:"block text-sm font-medium text-gray-700",children:"Total Cash"}),v.jsx(ds,{value:i,onChange:f=>c(Uy(f)),min:0,label:"Total Cash",className:"mt-1"})]})}function Py(i){const c=i.match(/[-+]?\d+(?:\.\d+)?/);return c?parseFloat(c[0]):0}function ls(i){const c=new Map;return i.forEach(f=>{f.attributes.forEach(s=>{const d=Py(s.value);c.set(s.type,(c.get(s.type)??0)+d)})}),c}function Db(i,c){let f=0;return c.forEach(s=>{f+=(i.get(s.type)??0)*s.weight}),f}function gi(i){switch(i){case"common":return"green";case"rare":return"blue";case"epic":return"purple";default:return"black"}}function Fy(i,c){const f=ls(i);return c.every(s=>s.attrs.reduce((p,y)=>p+(f.get(y)??0),0)>=s.value)}function Wb(i,c,f){const s=new Set(i.map(d=>d.type));return c&&f.forEach(d=>{d.attrs.forEach(p=>s.add(p))}),s.delete(""),s}function $y(i,c,f,s){const d=Wb(c,f,s),p=[];return c.forEach(y=>{const O=i.get(y.type)??0;p.push({type:y.type,sum:O,contrib:O*y.weight}),d.delete(y.type)}),d.forEach(y=>{const O=i.get(y)??0;p.push({type:y,sum:O,contrib:0})}),p}function rr(i){return{ALS:"Ability Life Steal",AP:"Ability Power",AS:"Attack Speed",Armor:"Armor",CR:"Cooldown Reduction",Health:"Health","Knockback Resist":"Knockback Resistance",MA:"Max Ammo",MD:"Melee Damage",MS:"Movement Speed",RS:"Reload Speed",Shields:"Shields",WP:"Weapon Power",WPLS:"Weapon Life Steal"}[i]||i}function nm(i,c){const f=["WP","AP","AS"],s=f.indexOf(i),d=f.indexOf(c);return s!==-1&&d!==-1?s-d:s!==-1?-1:d!==-1?1:i.localeCompare(c)}function Zb(i,c){const f={common:0,rare:1,epic:2},s=f[i.rarity]-f[c.rarity];return s!==0?s:i.name.localeCompare(c.name)}function em({items:i}){const c=me(y=>y.input.present.equipped),f=ct(),[s,d]=$.useState(!1),p=y=>{d(y),y||c.forEach((O,S)=>f(xb({index:S,id:""})))};return v.jsxs("div",{children:[v.jsx("label",{className:"block text-sm font-medium text-gray-700",children:"Equipped Items"}),v.jsxs("div",{className:"flex items-center gap-2 mt-1 mb-2",children:[v.jsx("input",{id:"use-equipped-checkbox",type:"checkbox",checked:s,onChange:y=>p(y.target.checked),className:"h-4 w-4 text-teal-600 border-gray-300 rounded focus:ring-teal-500"}),v.jsx("label",{htmlFor:"use-equipped-checkbox",className:"text-sm text-gray-700 select-none",children:"Use Equipped Items"})]}),s&&v.jsxs("div",{className:"space-y-4 mt-1",children:[c.map((y,O)=>v.jsxs("div",{className:"flex items-center gap-2",children:[v.jsx(Ia,{label:`Equipped Slot ${O+1}`,placeholder:"None",options:[{value:"",label:"None"},...i.sort(Zb).map(S=>({value:S.id||S.name,label:`${S.name} (${S.cost}) ${S.attributes.filter(g=>g.type!=="description").map(g=>`${rr(g.type)}-${g.value}`).join(", ")}`,color:gi(S.rarity)}))],value:y,onChange:S=>f(xb({index:O,id:S})),className:"flex-grow"}),c.length>2&&v.jsx("button",{type:"button",className:"flex-shrink-0 rounded p-2 text-gray-400 hover:bg-red-50 hover:text-red-600",onClick:()=>f(Wy(O)),children:v.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-4 w-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:v.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"})})})]},O)),c.length<6&&v.jsx("button",{type:"button",onClick:()=>f(ky()),className:"inline-flex items-center justify-center rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-800 hover:bg-gray-50",children:"Add Slot"})]})]})}function Ib({label:i,onRemove:c}){return v.jsxs("span",{className:"flex items-center gap-2 rounded-full bg-gray-100 px-3 py-1 text-sm text-gray-800",children:[i,c&&v.jsx("button",{type:"button",className:"text-red-500 hover:text-red-700 text-lg leading-none",onClick:c,children:"×"})]})}function tm({items:i}){const c=me(y=>y.input.present.avoid),f=me(y=>y.input.present.avoidEnabled),s=ct(),[d,p]=$.useState("");return v.jsxs("div",{children:[v.jsx("label",{className:"block text-sm font-medium text-gray-700",children:"Avoid Items"}),v.jsxs("div",{className:"flex items-center gap-2 mt-1 mb-2",children:[v.jsx("input",{id:"avoid-toggle",type:"checkbox",checked:f,onChange:()=>s(wy()),className:"h-4 w-4 text-teal-600 border-gray-300 rounded focus:ring-teal-500"}),v.jsx("label",{htmlFor:"avoid-toggle",className:"text-sm text-gray-700 select-none",children:"Enable Avoid Items"})]}),f&&v.jsxs(v.Fragment,{children:[v.jsxs("div",{className:"flex items-center gap-2",children:[v.jsx(Ia,{label:"Avoid Item",placeholder:"Select item",options:[{value:"",label:"Select item"},...i.sort(Zb).map(y=>({value:y.id||y.name,label:`${y.name} (${y.cost})`,color:gi(y.rarity)}))],value:d,onChange:p,className:"flex-grow"}),v.jsx("button",{type:"button",className:"rounded bg-gray-200 px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-300",onClick:()=>{d&&(s(Ly(d)),p(""))},children:"Add"})]}),c.length>0&&v.jsx("div",{className:"flex flex-wrap gap-2 mt-2",children:c.map(y=>{const O=i.find(S=>(S.id||S.name)===y);return v.jsx(Ib,{label:O?O.name:y,onRemove:()=>s(By(y))},y)})})]})]})}function rm({attrTypes:i}){const c=me(d=>d.input.present.weights),f=ct(),s=i.map(d=>({value:d,label:rr(d)}));return v.jsxs("div",{children:[v.jsx("label",{className:"block text-sm font-medium text-gray-700",children:"Attribute Weights"}),v.jsx("div",{className:"space-y-4 mt-1",children:c.map((d,p)=>v.jsxs("div",{className:"flex items-center gap-2",children:[v.jsx(Ia,{label:"Attribute Type",placeholder:"Select type",options:s,value:d.type,onChange:y=>f(kb({index:p,type:y})),className:"flex-grow"}),v.jsx(ds,{value:d.weight,onChange:y=>f(zy({index:p,value:y})),min:0,max:100,step:.01,label:`Weight for ${rr(d.type)}`,className:"w-24"}),c.length>1&&v.jsx("button",{type:"button",className:"flex-shrink-0 rounded p-2 text-gray-400 hover:bg-red-50 hover:text-red-600",onClick:()=>f(Gy(p)),children:v.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-4 w-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:v.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"})})})]},p))}),v.jsx("button",{type:"button",className:"mt-3 inline-flex items-center justify-center rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-800 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2",onClick:()=>f(jy(i[0])),children:"Add Row"})]})}function am({attrTypes:i}){const c=ct(),f=me(p=>p.input.present.minValueEnabled),s=me(p=>p.input.present.minAttrGroups),d=i.map(p=>({value:p,label:rr(p)}));return v.jsxs("div",{children:[v.jsx("label",{className:"block text-sm font-medium text-gray-700",children:"Minimum Attribute Totals"}),v.jsxs("div",{className:"flex items-center gap-2 mt-1 mb-2",children:[v.jsx("input",{id:"min-value-toggle",type:"checkbox",checked:f,onChange:()=>c(Yy()),className:"h-4 w-4 text-teal-600 border-gray-300 rounded focus:ring-teal-500"}),v.jsx("label",{htmlFor:"min-value-toggle",className:"text-sm text-gray-700 select-none",children:"Enable Minimum Values"})]}),f&&v.jsxs("div",{className:"space-y-4",children:[s.map((p,y)=>v.jsxs("div",{className:"rounded border p-3 space-y-2",children:[v.jsxs("div",{className:"flex items-center gap-2",children:[v.jsx("span",{className:"text-sm font-medium text-gray-700",children:"Target Value:"}),v.jsx(ds,{value:p.value,onChange:O=>c(Ky({index:y,value:O})),min:0,label:"Minimum Value",className:"w-24"}),s.length>1&&v.jsx("button",{type:"button",className:"flex-shrink-0 rounded p-2 text-gray-400 hover:bg-red-50 hover:text-red-600",onClick:()=>c(Vy(y)),children:v.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-4 w-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:v.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"})})})]}),v.jsx(Ia,{label:"Add Attribute",placeholder:"Add attribute",options:d.filter(O=>!p.attrs.includes(O.value)),value:"",onChange:O=>c(Qy({index:y,attr:O})),className:"w-full"}),p.attrs.length>0&&v.jsx("div",{className:"flex flex-wrap gap-2",children:p.attrs.map(O=>v.jsx(Ib,{label:rr(O),onRemove:()=>c(Xy({index:y,attr:O}))},O))})]},y)),v.jsx("button",{type:"button",className:"mt-3 inline-flex items-center justify-center rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-800 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2",onClick:()=>c(qy()),children:"Add Group"})]})]})}function lm({onSubmit:i,validate:c}){const f=ct(),s=me(p=>p.input.present.toBuy),d=me(p=>p.input.present.error);return v.jsxs("div",{className:"!mt-8 border-t pt-6",children:[v.jsx("button",{type:"button",onClick:()=>{c()&&i()},className:"w-full inline-flex items-center justify-center rounded-lg bg-teal-600 px-5 py-3 text-white text-base font-medium shadow-lg transition hover:bg-teal-700 disabled:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2",disabled:!c(),children:"Calculate Optimal Build"}),v.jsx("div",{className:"mt-4 grid grid-cols-5 gap-2",children:[2,3,4,5,6].map(p=>v.jsx("button",{type:"button",onClick:()=>f(Xb(p)),className:`rounded-lg py-2 text-sm font-medium ${s===p?"bg-indigo-600 text-white":"bg-gray-200 text-gray-700 hover:bg-gray-300"}`,children:p},p))}),d&&v.jsx("div",{role:"alert",className:"mt-4 rounded border-s-4 border-red-500 bg-red-50 p-4 text-sm font-medium text-red-800",children:d})]})}function im({heroes:i,attrTypes:c,filteredItems:f,onSubmit:s,validate:d}){return v.jsxs("form",{onSubmit:p=>{p.preventDefault(),d()&&s()},className:"space-y-6 bg-white rounded-xl shadow-lg p-6 sm:p-8",children:[v.jsx(Iy,{heroes:i}),v.jsx(Jy,{}),v.jsx(em,{items:f}),v.jsx(tm,{items:f}),v.jsx(am,{attrTypes:c}),v.jsx(rm,{attrTypes:c}),v.jsx(lm,{onSubmit:s,validate:d})]})}function um(i){return i.replace(/<[^>]*>/g,"")}function cm({eqItems:i,eqCost:c,cash:f,results:s,alternatives:d}){return v.jsxs("div",{className:"space-y-6 bg-white rounded-xl shadow-lg p-6 sm:p-8",children:[v.jsx("h2",{className:"text-2xl font-bold text-gray-900 sm:text-3xl",children:"Results"}),s?v.jsxs("div",{className:"space-y-6",children:[v.jsxs("div",{className:"grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3",children:[v.jsxs("div",{className:"flex flex-col rounded-lg border border-gray-100 bg-white p-4",children:[v.jsx("dt",{className:"order-2 text-sm font-medium text-gray-500",children:"Weighted Score"}),v.jsx("dd",{className:"order-1 text-2xl font-extrabold text-teal-600",children:s.score.toFixed(2)})]}),v.jsxs("div",{className:"flex flex-col rounded-lg border border-gray-100 bg-white p-4",children:[v.jsx("dt",{className:"order-2 text-sm font-medium text-gray-500",children:"Total Cost"}),v.jsx("dd",{className:"order-1 text-2xl font-extrabold text-indigo-600",children:c+s.cost})]}),v.jsxs("div",{className:"flex flex-col rounded-lg border border-gray-100 bg-white p-4",children:[v.jsx("dt",{className:"order-2 text-sm font-medium text-gray-500",children:"Cash Remaining"}),v.jsx("dd",{className:"order-1 text-2xl font-extrabold text-green-600",children:f-c-s.cost})]})]}),s.breakdown&&v.jsxs("div",{className:"text-sm text-gray-600",children:[v.jsx("strong",{children:"Breakdown:"}),v.jsxs("table",{className:"mt-2 w-full text-left border-collapse",children:[v.jsx("thead",{children:v.jsxs("tr",{children:[v.jsx("th",{className:"px-2 py-1 border-b font-medium",children:"Type"}),v.jsx("th",{className:"px-2 py-1 border-b font-medium",children:"Sum"}),v.jsx("th",{className:"px-2 py-1 border-b font-medium",children:"Contribution"})]})}),v.jsx("tbody",{children:s.breakdown.map(p=>v.jsxs("tr",{children:[v.jsx("td",{className:"px-2 py-1",children:rr(p.type)}),v.jsx("td",{className:"px-2 py-1",children:p.sum}),v.jsx("td",{className:"px-2 py-1",children:p.contrib.toFixed(2)})]},p.type))})]})]}),v.jsxs("div",{children:[v.jsx("h3",{className:"text-lg font-bold text-gray-800",children:"Final Build"}),v.jsx("ul",{className:"mt-2 space-y-3",children:[...i,...s.items].map(p=>v.jsxs("li",{className:"block rounded-lg border border-gray-200 p-4 transition hover:shadow-sm",style:{borderLeftColor:gi(p.rarity),borderLeftWidth:"4px"},children:[v.jsxs("div",{className:"flex justify-between items-center",children:[v.jsx("strong",{className:"font-semibold",style:{color:gi(p.rarity)},children:p.name}),v.jsxs("span",{className:"text-sm font-mono rounded-full bg-indigo-50 text-indigo-600 px-2 py-0.5",children:[p.cost," G"]})]}),v.jsx("ul",{className:"mt-2 text-xs text-gray-600 space-y-1",children:p.attributes.map((y,O)=>v.jsx("li",{className:"flex items-start",children:v.jsxs("span",{children:[v.jsxs("span",{className:"font-medium",children:[rr(y.type),":"]}),v.jsx("span",{className:"ml-1 text-gray-800 break-words",children:v.jsx("strong",{children:um(y.value)})})]})},O))})]},p.id))})]}),d.length>0&&v.jsxs("div",{children:[v.jsx("h3",{className:"text-lg font-bold text-gray-800",children:"Alternative Builds"}),v.jsx("ul",{className:"mt-2 space-y-2 rounded-lg border border-gray-200 bg-gray-50 p-3 max-h-48 overflow-y-auto",children:d.map((p,y)=>v.jsxs("li",{className:"text-sm text-gray-700 p-2 rounded-md hover:bg-gray-100",children:[v.jsxs("strong",{children:["Cost: ",p.cost]})," - ",p.items.map(O=>O.name).join(", ")]},y))})]})]}):v.jsxs("div",{className:"text-center rounded-lg border-2 border-dashed border-gray-200 p-12",children:[v.jsx("svg",{className:"mx-auto h-12 w-12 text-gray-400",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor","aria-hidden":"true",children:v.jsx("path",{vectorEffect:"non-scaling-stroke",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V7a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"})}),v.jsx("h3",{className:"mt-2 text-sm font-medium text-gray-900",children:"No results yet"}),v.jsx("p",{className:"mt-1 text-sm text-gray-500",children:"Fill out the form and click calculate to see the magic."})]})]})}function sm(i,c){const d=Math.min(c?3.5:7,i*(c?.25:.5));return i-d}function om(i,c,f,s,d){if(i<=0||c<=0)return{shots:1/0,totalDamage:0};let p=f,y=s,O=0,S=0;for(;p>0;){O++;for(let g=0;g<c;g++){let N=i;if(y>0){N=sm(N,d);const L=Math.min(N,y);y-=L,N-=L}if(p-=N,S+=i,p<=0)break}}return{shots:O,totalDamage:S}}function fm(i,c,f,s,d){const p=[];for(let y=100;y<=200;y+=5){const O=i*(y/100),{shots:S,totalDamage:g}=om(O,c,f,s,d);p.push({percent:y,shots:S,totalDamage:g})}return p}function dm(){const[i,c]=$.useState(!0),[f,s]=$.useState(75),[d,p]=$.useState(1),[y,O]=$.useState(300),[S,g]=$.useState(0),[N,L]=$.useState(!1),[j,W]=$.useState([]),P=()=>{W(fm(f,d,y,S,N))};return v.jsxs("div",{className:"bg-white rounded-xl shadow-lg",children:[v.jsx("button",{className:"w-full text-left p-4 font-bold text-xl border-b",onClick:()=>c(!i),children:"Break Point Damage Calculator"}),!i&&v.jsxs("div",{className:"p-4 space-y-4",children:[v.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-3 gap-4",children:[v.jsxs("label",{className:"space-y-1",children:[v.jsx("span",{className:"block text-sm",children:"Damage per Bullet"}),v.jsx("input",{type:"number",value:f,onChange:K=>s(Number(K.target.value)),className:"w-full border rounded p-1"})]}),v.jsxs("label",{className:"space-y-1",children:[v.jsx("span",{className:"block text-sm",children:"Bullets per Shot"}),v.jsx("input",{type:"number",value:d,onChange:K=>p(Number(K.target.value)),className:"w-full border rounded p-1"})]}),v.jsxs("label",{className:"space-y-1",children:[v.jsx("span",{className:"block text-sm",children:"Enemy HP"}),v.jsx("input",{type:"number",value:y,onChange:K=>O(Number(K.target.value)),className:"w-full border rounded p-1"})]}),v.jsxs("label",{className:"space-y-1",children:[v.jsx("span",{className:"block text-sm",children:"Enemy Armor"}),v.jsx("input",{type:"number",value:S,onChange:K=>g(Number(K.target.value)),className:"w-full border rounded p-1"})]}),v.jsxs("label",{className:"flex items-center space-x-2 mt-6",children:[v.jsx("input",{type:"checkbox",checked:N,onChange:K=>L(K.target.checked)}),v.jsx("span",{children:"Using armor penetration item"})]})]}),v.jsx("button",{onClick:P,className:"bg-indigo-600 text-white px-4 py-1 rounded",children:"Calculate"}),j.length>0&&v.jsxs("table",{className:"w-full text-sm mt-4 border",children:[v.jsx("thead",{children:v.jsxs("tr",{children:[v.jsx("th",{className:"border px-2 py-1",children:"Damage %"}),v.jsx("th",{className:"border px-2 py-1",children:"Per Bullet"}),v.jsx("th",{className:"border px-2 py-1",children:"Per Shot"}),v.jsx("th",{className:"border px-2 py-1",children:"Shots"}),v.jsx("th",{className:"border px-2 py-1",children:"Accumulated"})]})}),v.jsx("tbody",{children:j.map((K,Z)=>{const bn=Z>0?j[Z-1].shots:K.shots,sn=K.shots<bn,on=f*K.percent/100,I=on*d;return v.jsxs("tr",{className:sn?"bg-yellow-100":"",children:[v.jsxs("td",{className:"border px-2 py-1",children:[K.percent,"%"]}),v.jsx("td",{className:"border px-2 py-1",children:on.toFixed(1)}),v.jsx("td",{className:"border px-2 py-1",children:I.toFixed(1)}),v.jsx("td",{className:"border px-2 py-1",children:K.shots}),v.jsx("td",{className:"border px-2 py-1",children:K.totalDamage.toFixed(1)})]},K.percent)})})]})]})]})}const bm=`{\r
  "tabs": {\r
    "weapon": {\r
      "common": [\r
        {\r
...
}`;function hm(){const[i,c]=$.useState([]),[f,s]=$.useState([]),[d,p]=$.useState([]),y=ct(),O=me(fn=>fn.input.present),{hero:S,cash:g,equipped:N,toBuy:L,avoid:j,avoidEnabled:W,weights:P,minValueEnabled:K,minAttrGroups:Z}=O,[bn,sn]=$.useState(null),[on,I]=$.useState([]);$.useEffect(()=>{const fn=JSON.parse(bm),xn=JSON.parse(pm),Nn=[],x=(M,B,w)=>{w.forEach(Y=>{const nn=xn[Y.name],X={...Y,tab:M,rarity:B};nn!=null&&nn.attributes&&(X.attributes=nn.attributes),Nn.push(X)})};["weapon","ability","survival"].forEach(M=>{const B=fn.tabs[M];x(M,"common",B.common),x(M,"rare",B.rare),x(M,"epic",B.epic)}),c(Nn);const z=new Set,q=new Map,an=new Set;Nn.forEach(M=>{M.character&&z.add(M.character),M.attributes.forEach(B=>{const w=(q.get(B.type)??0)+1;q.set(B.type,w),w===2&&an.add(B.type)})}),an.delete("description"),an.delete("Editor's Note");const h=Array.from(an).sort(nm);s(Array.from(z).sort()),p(h),y(kb({index:0,type:h[0]}))},[]),$.useEffect(()=>{const fn=N.filter(xn=>xn).length;L+fn>6&&y(Xb(Math.max(0,6-fn)))},[y,N,L]);function U(){return N.map(fn=>i.find(xn=>xn.id===fn)).filter(fn=>!!fn)}function F(){if(!S||g<0||U().reduce((xn,Nn)=>xn+Nn.cost,0)>g||L+U().length>6||P.length===0)return!1;if(K){for(const xn of Z)if(xn.attrs.length===0||xn.value<0)return!1}return!0}function hn(fn){const xn=ls(fn);return Db(xn,P)}function mn(fn){return!K||Fy([...fn,...U()],Z)}function vn(){y(di(""));const fn=U(),xn=fn.reduce((ln,Dn)=>ln+Dn.cost,0),Nn=g-xn;if(Nn<0){y(di("Equipped items cost exceeds total cash"));return}const x=Wb(P,K,Z),z=i.filter(ln=>(!ln.character||ln.character===S)&&!N.includes(ln.id??"")&&(!W||!j.includes(ln.id??""))&&ln.attributes.some(Dn=>x.has(Dn.type))),q=L;if(q===0){if(!mn([])){y(di("Minimum attribute values not met"));return}const ln=hn(fn);sn({items:[],cost:0,score:ln}),I([]);return}const an=z.map(ln=>({item:ln,score:hn([ln])}));an.sort((ln,Dn)=>Dn.score-ln.score);const h=[0];for(const ln of an)h.push(h[h.length-1]+ln.score);let M=-1/0,B=0,w=[];const Y=fn.length+q===6,nn=an.length;function X(ln,Dn,ue,Ge){if(mn(Dn)&&(Ge>M||Ge===M&&(Y?ue>B:ue<B)?(M=Ge,B=ue,w=[{items:[...Dn],cost:ue,score:Ge}]):Ge===M&&(Y?ue<=B:ue>=B)&&w.push({items:[...Dn],cost:ue,score:Ge})),Dn.length===q||ln>=nn)return;const Oi=q-Dn.length;if(!(Ge+(h[Math.min(nn,ln+Oi)]-h[ln])<M))for(let ir=ln;ir<nn;ir++){const Lt=an[ir];ue+Lt.item.cost>Nn||(Dn.push(Lt.item),X(ir+1,Dn,ue+Lt.item.cost,Ge+Lt.score),Dn.pop())}}if(X(0,[],0,0),w.length===0){y(di("Insufficient cash for any purchase"));return}const[Gn,..._n]=w.sort((ln,Dn)=>Y?Dn.cost-ln.cost:ln.cost-Dn.cost),je=_n.filter(ln=>Y?ln.cost<Gn.cost:ln.cost>Gn.cost).sort((ln,Dn)=>Y?Dn.cost-ln.cost:ln.cost-Dn.cost),ar=ls([...Gn.items,...fn]),lr=$y(ar,P,K,Z);sn({items:Gn.items,cost:Gn.cost,score:Db(ar,P),breakdown:lr}),I(je.map(ln=>({...ln,score:hn([...ln.items,...fn])})))}if(i.length===0)return v.jsx("div",{className:"p-4",children:"Loading..."});const Ce=i.filter(fn=>!S||!fn.character||fn.character===S),ee=U(),wn=ee.reduce((fn,xn)=>fn+xn.cost,0);return v.jsxs("div",{className:"bg-gray-50 min-h-screen p-4 sm:p-6 lg:p-8 space-y-8",children:[v.jsxs("div",{className:"max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8",children:[v.jsx(im,{heroes:f,attrTypes:d,filteredItems:Ce,onSubmit:vn,validate:F}),v.jsx(cm,{eqItems:ee,eqCost:wn,cash:g,results:bn,alternatives:on})]}),v.jsx("div",{className:"max-w-7xl mx-auto",children:v.jsx(dm,{})})]})}const De={UNDO:"@@redux-undo/UNDO",REDO:"@@redux-undo/REDO",JUMP_TO_FUTURE:"@@redux-undo/JUMP_TO_FUTURE",JUMP_TO_PAST:"@@redux-undo/JUMP_TO_PAST",JUMP:"@@redux-undo/JUMP",CLEAR_HISTORY:"@@redux-undo/CLEAR_HISTORY"},bi={undo(){return{type:De.UNDO}},redo(){return{type:De.REDO}},jumpToFuture(i){return{type:De.JUMP_TO_FUTURE,index:i}},jumpToPast(i){return{type:De.JUMP_TO_PAST,index:i}},jump(i){return{type:De.JUMP,index:i}},clearHistory(){return{type:De.CLEAR_HISTORY}}};function Mb(i,c=[]){return Array.isArray(i)?i:typeof i=="string"?[i]:c}function ym(i){return typeof i.present<"u"&&typeof i.future<"u"&&typeof i.past<"u"&&Array.isArray(i.future)&&Array.isArray(i.past)}function nr(i,c,f,s=null){return{past:i,present:c,future:f,group:s,_latestUnfiltered:c,index:i.length,limit:i.length+f.length+1}}let _i,Me;const is={prevState:"#9E9E9E",action:"#03A9F4",nextState:"#4CAF50"};function mm(){Me={header:[],prev:[],action:[],next:[],msgs:[]}}function vm(){const{header:i,prev:c,next:f,action:s,msgs:d}=Me;console.group?(console.groupCollapsed(...i),console.log(...c),console.log(...s),console.log(...f),console.log(...d),console.groupEnd()):(console.log(...i),console.log(...c),console.log(...s),console.log(...f),console.log(...d))}function us(i,c,f){return[`%c${i}`,`color: ${c}; font-weight: bold`,f]}function gm(i,c){mm(),_i&&(console.group?(Me.header=["%credux-undo","font-style: italic","action",i.type],Me.action=us("action",is.action,i),Me.prev=us("prev history",is.prevState,c)):(Me.header=["redux-undo action",i.type],Me.action=["action",i],Me.prev=["prev history",c]))}function we(i){_i&&(console.group?Me.next=us("next history",is.nextState,i):Me.next=["next history",i],vm())}function $n(...i){_i&&(Me.msgs=Me.msgs.concat([...i,`
`]))}function Sm(i){_i=i}function Pc(i,c){const f=nr([],i,[]);return c&&(f._latestUnfiltered=null),f}function Em(i,c,f,s){const d=i.past.length+1;$n("inserting",c),$n("new free: ",f-d);const{past:p,_latestUnfiltered:y}=i,O=f&&f<=d,S=p.slice(O?1:0),g=y!=null?[...S,y]:S;return nr(g,c,[],s)}function Jb(i,c){if(c<0||c>=i.future.length)return i;const{past:f,future:s,_latestUnfiltered:d}=i,p=[...f,d,...s.slice(0,c)],y=s[c],O=s.slice(c+1);return nr(p,y,O)}function Pb(i,c){if(c<0||c>=i.past.length)return i;const{past:f,future:s,_latestUnfiltered:d}=i,p=f.slice(0,c),y=[...f.slice(c+1),d,...s],O=f[c];return nr(p,O,y)}function Fc(i,c){return c>0?Jb(i,c-1):c<0?Pb(i,i.past.length+c):i}function Am(i,c){return c.indexOf(i)>-1?i:!i}function Rm(i,c={}){Sm(c.debug);const f={limit:void 0,filter:()=>!0,groupBy:()=>null,undoType:De.UNDO,redoType:De.REDO,jumpToPastType:De.JUMP_TO_PAST,jumpToFutureType:De.JUMP_TO_FUTURE,jumpType:De.JUMP,neverSkipReducer:!1,ignoreInitialState:!1,syncFilter:!1,...c,initTypes:Mb(c.initTypes,["@@redux-undo/INIT"]),clearHistoryType:Mb(c.clearHistoryType,[De.CLEAR_HISTORY])},s=f.neverSkipReducer?(p,y,...O)=>({...p,present:i(p.present,y,...O)}):p=>p;let d;return(p=d,y={},...O)=>{gm(y,p);let S=p;if(!d)if($n("history is uninitialized"),p===void 0){const N=i(p,{type:"@@redux-undo/CREATE_HISTORY"},...O);return S=Pc(N,f.ignoreInitialState),$n("do not set initialState on probe actions"),we(S),S}else ym(p)?(S=d=f.ignoreInitialState?p:nr(p.past,p.present,p.future),$n("initialHistory initialized: initialState is a history",d)):(S=d=Pc(p,f.ignoreInitialState),$n("initialHistory initialized: initialState is not a history",d));let g;switch(y.type){case void 0:return S;case f.undoType:return g=Fc(S,-1),$n("perform undo"),we(g),s(g,y,...O);case f.redoType:return g=Fc(S,1),$n("perform redo"),we(g),s(g,y,...O);case f.jumpToPastType:return g=Pb(S,y.index),$n(`perform jumpToPast to ${y.index}`),we(g),s(g,y,...O);case f.jumpToFutureType:return g=Jb(S,y.index),$n(`perform jumpToFuture to ${y.index}`),we(g),s(g,y,...O);case f.jumpType:return g=Fc(S,y.index),$n(`perform jump to ${y.index}`),we(g),s(g,y,...O);case Am(y.type,f.clearHistoryType):return g=Pc(S.present,f.ignoreInitialState),$n("perform clearHistory"),we(g),s(g,y,...O);default:if(g=i(S.present,y,...O),f.initTypes.some(L=>L===y.type))return $n("reset history due to init action"),we(d),d;if(S._latestUnfiltered===g)return S;if(typeof f.filter=="function"&&!f.filter(y,g,S)){const L=nr(S.past,g,S.future,S.group);return f.syncFilter||(L._latestUnfiltered=S._latestUnfiltered),$n("filter ignored action, not storing it in past"),we(L),L}const N=f.groupBy(y,g,S);if(N!=null&&N===S.group){const L=nr(S.past,g,S.future,S.group);return $n("groupBy grouped the action with the previous action"),we(L),L}return S=Em(S,g,f.limit,N),$n("inserted new state into history"),we(S),S}}}function Tm(i){return`${i.hero} - $${i.cash}`}function _m({history:i}){const[c,f]=$.useState(!1),s=$.useRef(null);return $.useEffect(()=>{const d=p=>{s.current&&!s.current.contains(p.target)&&f(!1)};return document.addEventListener("mousedown",d),()=>document.removeEventListener("mousedown",d)},[]),v.jsxs("div",{className:"relative",ref:s,children:[v.jsxs("button",{type:"button",onClick:()=>f(d=>!d),className:"flex items-center gap-1 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50",children:["History",v.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:"1.5",stroke:"currentColor",className:"size-4",children:v.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"m19.5 8.25-7.5 7.5-7.5-7.5"})})]}),c&&v.jsx("div",{className:"absolute z-10 mt-2 w-48 max-h-40 overflow-y-auto rounded border border-gray-300 bg-white text-sm shadow-lg",children:i.length>0?v.jsx("ul",{children:i.map((d,p)=>v.jsx("li",{className:"border-b px-3 py-2 last:border-none",children:Tm(d)},p))}):v.jsx("p",{className:"p-3 text-gray-500",children:"No history"})})]})}function Om(){const i=ct(),c=me(s=>s.input.past),f=me(s=>s.input.future);return $.useEffect(()=>{const s=d=>{d.ctrlKey&&d.key.toLowerCase()==="z"&&(d.preventDefault(),d.shiftKey?i(bi.redo()):i(bi.undo()))};return window.addEventListener("keydown",s),()=>window.removeEventListener("keydown",s)},[i]),v.jsxs("div",{className:"mb-6 flex items-center justify-between gap-4",children:[v.jsxs("div",{className:"flex gap-2",children:[v.jsx("button",{type:"button",disabled:c.length===0,onClick:()=>i(bi.undo()),className:"rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow hover:bg-indigo-700 disabled:bg-gray-400",children:"Undo"}),v.jsx("button",{type:"button",disabled:f.length===0,onClick:()=>i(bi.redo()),className:"rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow hover:bg-indigo-700 disabled:bg-gray-400",children:"Redo"})]}),v.jsx(_m,{history:c})]})}function Nm(){return v.jsx("div",{className:"min-h-screen bg-gradient-to-br from-teal-50 to-blue-100 p-6 text-gray-800",children:v.jsxs("div",{className:"max-w-5xl mx-auto",children:[v.jsx(Om,{}),v.jsx(hm,{})]})})}const xm=vy({reducer:{input:Rm(Zy)}});Oh.createRoot(document.getElementById("root")).render(v.jsx($.StrictMode,{children:v.jsx(qh,{store:xm,children:v.jsx(Nm,{})})}));
