// Utility to compute Juno torpedo breakpoints based on provided specification.
...
export type JunoBreakpointOptions = {
  baseDamage?: number;
  minCash?: number;
  maxCash?: number;
  maxItems?: number;
...
export type JunoBreakpoint = TorpedoCandidate & { budget: number };

export function computeJunoTorpedoBreakpoints(
  enabledItems: TorpedoItem[],
  opts: JunoBreakpointOptions = {},
): JunoBreakpoint[] {
